...
function useApiRequest() {
     ...
     */
    var executeRequest = (0, react_1.useCallback)(function (apiCall) { return __awaiter(_this, void 0, void 0, function () {
        var result, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error('Помилка API-запиту:', err_1);
                    setError(err_1 instanceof Error ? err_1 : new Error('Невідома помилка'));
    ...
    return { loading: loading, error: error, executeRequest: executeRequest, clearError: clearError };
}
