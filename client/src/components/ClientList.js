...
var ClientList = function () {
    ...
    var _b = (0, useApiRequest_1.useApiRequest)(), loading = _b.loading, executeRequest = _b.executeRequest;
    (0, react_1.useEffect)(function () {
        var fetchClients = function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, executeRequest(function () { return (0, api_1.getClients)(); })];
                    case 1:
                        result = _a.sent();
                        if (result) {
                            setClients(result);
    ...
    return (<div className="container mx-auto px-4 py-6">
      ...
      {loading ? (<div className="flex justify-center items-center py-8">
          ...
          {clients.length === 0 ? (<div className="p-4 text-center text-gray-500">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {clients.map(function (client) { return (<tr key={client.id} className="hover:bg-gray-50">
...
exports.default = exports.ClientList;
